...
public class AllTransactionsAdapter extends RecyclerView.Adapter<AllTransactionsAdapter.ViewHolder> {
    ...
    public AllTransactionsAdapter(Context context, ArrayList<Transaction> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from (viewGroup.getContext()).inflate(R.layout.all_transactions_item, viewGroup, false);
