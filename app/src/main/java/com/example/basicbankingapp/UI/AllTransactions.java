...
import com.example.basicbankingapp.Adapter.AllTransactionsAdapter;
...
public class AllTransactions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new AllTransactionsAdapter(this, transactionArrayList);
    ...
    private void displayDatabaseInfo() {
        ...
        String[] projection = {
                TransactionContract.TransactionEntryData.COLUMN_FROM_NAME,
                TransactionContract.TransactionEntryData.COLUMN_TO_NAME,
                TransactionContract.TransactionEntryData.COLUMN_AMOUNT,
                TransactionContract.TransactionEntryData.COLUMN_STATUS
        };

        Log.d("TAG", "displayDataBaseInfo()2");

        Cursor cursor = db.query(
                TransactionContract.TransactionEntryData.TABLE_NAME,   // The table to query
        ...
        try {
            ...
            int fromNameColumnIndex = cursor.getColumnIndex(TransactionContract.TransactionEntryData.COLUMN_FROM_NAME);
            int ToNameColumnIndex = cursor.getColumnIndex(TransactionContract.TransactionEntryData.COLUMN_TO_NAME);
            int amountColumnIndex = cursor.getColumnIndex(TransactionContract.TransactionEntryData.COLUMN_AMOUNT);
            int statusColumnIndex = cursor.getColumnIndex(TransactionContract.TransactionEntryData.COLUMN_STATUS);
