...
public class UserProfile extends AppCompatActivity {
    ...
    TextView name, email, accountNumber, balance, phoneNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null){
            ...
            accountNumber.setText(String.valueOf(extras.getInt("ACCOUNT_NO")));
            email.setText(extras.getString("EMAIL"));
            phoneNumber.setText(extras.getString("PHONE_NO"));
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mAmount.getText().toString().isEmpty()) {
                    ...
                    Intent intent = new Intent(UserProfile.this, SelectUserToTransfer.class);
                    intent.putExtra("FROM_USER_ACCOUNT_NO", Integer.parseInt(accountNumber.getText().toString()));    // PRIMARY_KEY
